...
Nova.booting(function (Vue, router) {
    Vue.component('index-email', __webpack_require__(3));
    Vue.component('detail-email', __webpack_require__(6));
    Vue.component('form-email', __webpack_require__(9));
});
